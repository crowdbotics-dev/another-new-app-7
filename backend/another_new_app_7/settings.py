"""
Django settings for another_new_app_7 project.
...
ROOT_URLCONF = 'another_new_app_7.urls'
...
WSGI_APPLICATION = 'another_new_app_7.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Another new app Support <support@another-new-app-7.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "another_new_app_7 API",
    "DESCRIPTION": "API documentation for another_new_app_7 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "another_new_app_7.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "another_new_app_7.storage_backends.AzureStaticStorage"
